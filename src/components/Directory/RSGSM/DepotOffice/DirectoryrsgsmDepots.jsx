...
import DirectoryrsgsmDepotsTable from './DirectoryrsgsmDepotsTable'
import axios from 'axios'
import Spinner from '../../../Loader/Spinner'
import { Link } from 'react-router-dom'

const DirectoryrsgsmDepots = () => {
    // loader
    ...
    const fetchData = async () => {
        try {
            const response = await axios.get('/api/v1/public/directory/rsgsm-depots', {
                params: {
                    page: currentPage,
                    size: 10
                }
            ...
            if (response.status === 200) {
                setdepots(response.data.data.content);  // Set the news state with the fetched data
    ...
    return (
        <div className="w-full mx-auto px-4 py-4 md:w-[90%]">
                ...
                <ol className="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                    ...
                    <li aria-current="page">
                        <div className="flex items-center">
                            ...
                            <span className="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">RSGSM Depots</span>
                        </div>
                    </li>
                </ol>
            </div>
            ...
            {/* Heading  */}
            <h2 className="mb-4 text-2xl font-extrabold leading-none text-gray-600 md:text-3xl dark:text-slate-300 tracking-wide">RSGSM Depots office</h2>
            <DirectoryrsgsmDepotsTable data={depots} />
...
export default DirectoryrsgsmDepots
