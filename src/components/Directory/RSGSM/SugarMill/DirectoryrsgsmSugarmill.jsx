...
const DirectoryrsgsmSugarmill = () => {
    ...
    const fetchData = async () => {
        try {
            const response = await axios.get('/api/v1/public/directory/rsgsm-sugar-mills', {
                params: {
                    page: currentPage,
                    size: 10
                }
            ...
            if (response.status === 200) {
                setsugarMills(response.data.data.content);  // Set the news state with the fetched data
    ...
    return (
        <div className="w-full mx-auto px-4 py-4 md:w-[90%]">
            ...
            <DirectoryrsgsmSugarmillTable data={sugarMills} />
