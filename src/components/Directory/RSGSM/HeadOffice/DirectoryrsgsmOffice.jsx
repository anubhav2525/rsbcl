...
import DirectoryrsgsmOfficeTable from './DirectoryrsgsmOfficeTable'
import { Link } from 'react-router-dom'

const DirectoryrsgsmOffice = () => {
    // loader
    ...
    return (
        <div className="w-full mx-auto px-4 py-4 md:w-[90%]">
                ...
                <ol className="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                    ...
                    <li aria-current="page">
                        <div className="flex items-center">
                            ...
                            <span className="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">RSGSM Head Office</span>
                        </div>
                    </li>
                </ol>
            </div>
            ...
            {/* Heading  */}
            <h2 className="mb-4 text-2xl font-extrabold leading-none text-gray-600 md:text-3xl dark:text-slate-300 tracking-wide">RSGSM Head Office</h2>

            <DirectoryrsgsmOfficeTable data={officeContacts} />
...
export default DirectoryrsgsmOffice
