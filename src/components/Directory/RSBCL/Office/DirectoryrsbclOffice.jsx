...
import DirectoryrsbclTable from './DirectoryrsbclTable';
import axios from 'axios';
import Spinner from '../../../Loader/Spinner';
import { Link } from 'react-router-dom';
const DirectoryrsbclOffice = () => {
    // loader
    ...
    const fetchData = async () => {
        try {
            ...
            if (response.status === 200) {
                setoffice(response.data.data.content);  // Set the news state with the fetched data
                ...
                <ol className="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                    ...
                    <li aria-current="page">
                        <div className="flex items-center">
                            ...
                            <span className="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">RSBCL Office</span>
                        </div>
                    </li>
                </ol>
            </div>
...
export default DirectoryrsbclOffice
