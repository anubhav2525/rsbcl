...
import DirectoryrsbclDepotsTable from "../Depots/DirectoryrsbclDepotsTable"
import { Link } from 'react-router-dom';

const DirectoryrsbclDepots = () => {
    // loader
    ...
    return (
        <div className="w-full mx-auto px-4 py-4 md:w-[90%]">
                ...
                <ol className="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                    ...
                    <li>
                        <div className="flex items-center">
                            ...
                            <span className="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">RSBCL Depots</span>
                        </div>
                    </li>
                </ol>
            </div>
            ...
            <DirectoryrsbclDepotsTable data={depots} />
...
export default DirectoryrsbclDepots
