...
const ContactCard = () => {
    return (
        <div className="bg-gradient-to-r from-cyan-500 to-blue-500 text-white rounded-xl shadow-lg p-6">
            ...
            <div className="flex items-center mb-2 ">
                ...
                <span className='ml-3'>123 Anywhere St., Any City, ST 12345</span>
            </div>
            <div className="flex items-center mb-2">
                <svg className="w-10 text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="flex items-center mb-2">
                ...
                <span className='ml-3'>hello@reallygreatsite.com</span>
            </div>
            <div className="flex items-center mb-2">
                <svg className="w-10 text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
                ...
                <span className='ml-3'>www.reallygreatsite.com</span>
            </div>
        </div>
    )
}
