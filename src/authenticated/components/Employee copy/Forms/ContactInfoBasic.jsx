            ...
            <div className='p-4'>
                <div className='w-full grid grid-cols-1 md:grid-cols-3 gap-4'>
                    <div >
                        ...
                        {errors.contactInfo?.email && <p className="mt-2 text-end text-xs text-red-600 dark:text-red-400">{errors.contactInfo.email.message}</p>}
                    </div>
                    <div>
                        <label
                            htmlFor="phoneNumber"
                        ...
                        {errors.contactInfo?.phoneNumber && <p className="mt-2 text-end text-xs text-red-600 dark:text-red-400">{errors.contactInfo.phoneNumber.message}</p>}
                    </div>
                    <div>
                        <label
                        ...
                        {errors.contactInfo?.emergencyContact && <p className="mt-2 text-end text-xs text-red-600 dark:text-red-400">{errors.contactInfo.emergencyContact.message}</p>}
                    </div>
                    <div className='md:col-span-3'>
                        ...
                        <input
                            ...
                            {...register('contactInfo.address.streetAddress')}
                            className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        />
                        {errors.contactInfo?.address?.streetAddress && <p className="mt-2 text-end text-xs text-red-600 dark:text-red-400">{errors.contactInfo.address.streetAddress.message}</p>}
                    </div>
                    <div className='md:col-span-3'>
                        <div className='w-full grid md:grid-cols-4 gap-3'>
                            <div>
                                ...
                                {errors.contactInfo?.address?.state && <p className="mt-2 text-end text-xs text-red-600 dark:text-red-400">{errors.contactInfo.address.state.message}</p>}
                            </div>
                            <div className={`${selectedState ? '' : 'hidden'}`}>
                                ...
                                {errors.contactInfo?.address?.city && <p className="mt-2 text-end text-xs text-red-600 dark:text-red-400">{errors.contactInfo.address.city.message}</p>}
                            </div>
                            <div>
                                <label
                                    htmlFor="pincode"
                                ...
                                {errors.contactInfo?.address?.pincode && <p className="mt-2 text-end text-xs text-red-600 dark:text-red-400">{errors.contactInfo.address.pincode.message}</p>}
                            </div>
                            <div>
                                <label
                                    htmlFor="country"
                                ...
                                {errors.contactInfo?.address?.country && <p className="mt-2 text-end text-xs text-red-600 dark:text-red-400">{errors.contactInfo.address.country.message}</p>}
                            </div>
                        </div>
                    </div>
                </div>
