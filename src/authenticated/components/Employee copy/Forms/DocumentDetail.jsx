                            ...
                            <div className='w-full gap-y-4 grid md:grid-cols-2 md:gap-x-4'>
                                <div>
                                    ...
                                    <input
                                        type="number"
                                        id="aadharNumber"
                                        {...register('identificationInfo.aadharNumber')}
                                        placeholder="1234-1234-1234"
                                        className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    />
                                    {errors.identificationInfo?.aadharNumber && <p className="mt-2 text-end text-xs text-red-600 dark:text-red-400">{errors.identificationInfo.aadharNumber.message}</p>}
                                </div>
                                {/* <div>
                                    <label
                                ...
                                <div>
                                    ...
                                    <input
                                        type="text"
                                        id="pancardId"
                                        {...register('identificationInfo.pancardId')}
                                        placeholder="AB12345678"
                                        required
                                        className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    />
                                    {errors.identificationInfo?.pancardId && <p className="mt-2 text-end text-xs text-red-600 dark:text-red-400">{errors.identificationInfo.pancardId.message}</p>}
                                </div>
                                {/* <div>
                                    <label
