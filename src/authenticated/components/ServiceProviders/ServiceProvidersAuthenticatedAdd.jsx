...
const ServiceProvidersAuthenticatedAdd = () => {
    ...
    const saveData = async (data) => {
        ...
        try {
            const response = await axios.post("/api/v1/auth/services", formData, {
                headers: {
        ...
        <div className='px-2 py-3'>
            ...
            <div className='bg-white border-gray-200 rounded shadow px-2 py-3  dark:bg-gray-800'>
                <div className='flex justify-between items-center'>
                    <div>
                        <h5 className="text-xl px-3 font-bold dark:text-white">Add new service providers</h5>
                    </div>
                    <div>
...
export default ServiceProvidersAuthenticatedAdd
