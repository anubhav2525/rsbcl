...
const ServiceProvidersAuthenticatedRemove = ({ setdeleteModal, deleteModal, id, setAlertMsg, fetchData }) => {
  const [removedStatus, setremovedStatus] = useState(false);
    const [msg, setMsg] = useState("");
    const handleDeleteRecordById = async () => {
        try {
            const response = await axios.delete(`/api/v1/auth/services/id/${id}`);
    ...
    return (
        <div>
            <div>
                ...
                <h3 className="mb-2 text-lg font-normal text-gray-500 dark:text-gray-100">Are you sure you want to delete this service?</h3>
                <p className="mb-5 text-sm font-normal text-gray-500 dark:text-gray-200">service id: {id}</p>
...
export default ServiceProvidersAuthenticatedRemove
