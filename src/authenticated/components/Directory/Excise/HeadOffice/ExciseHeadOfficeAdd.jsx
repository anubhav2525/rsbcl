...
const ExciseHeadOfficeAdd = () => {
    ...
    const saveData = async (data) => {
        ...
        try {
            const response = await axios.post("/api/v1/auth/directory/excise-office", formData, {
                headers: {
        ...
        <div className='px-2 py-3'>
            ...
            <div className='bg-white border-gray-200 rounded shadow px-2 py-3  dark:bg-gray-800'>
                <div className='flex justify-between items-center'>
                    <div>
                        <h5 className="text-xl px-3 font-bold dark:text-white">Add new directory excise: Head Office</h5>
                    </div>
                    <div>
                    ...
                    <form onSubmit={handleSubmit(onSubmit)}>
                        <div className='w-full grid grid-cols-1 md:grid-cols-2 gap-4'>
                            ...
                            <div>
                                <label
                                    htmlFor="stdCode"
                                    className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">STD Code</label>
                                <input
                                    type="text"
                                    id="stdCode"
                                    placeholder="Enter STD code"
                                    {...register('stdCode', { required: "STD Code is required" })}
                                    className={`bg-gray-50 border ${errors.stdCode ? "border-red-500" : "border-gray-300 dark:border-gray-600"} text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700  dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500`}
                                />
                                {errors.stdCode && <p className="mt-2 text-xs text-red-600 dark:text-red-400">{errors.stdCode.message}</p>}
                            </div>
                            ...
                            <div>
                                <label
                                    htmlFor="faxNo"
                                    className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Fax Number</label>
                                <input
                                    type="text"
                                    id="faxNo"
                                    placeholder="Enter fax number"
                                    {...register('faxNo', { required: "FAX number is required", })}
                                    className={`bg-gray-50 border ${errors.faxNo ? "border-red-500" : "border-gray-300 dark:border-gray-600"} text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700  dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500`}
                                />
                                {errors.faxNo && <p className="mt-2 text-xs text-red-600 dark:text-red-400">{errors.faxNo.message}</p>}
                            </div>
                            ...
                            <div>
                                <label
                                    ...
                                    className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Office Address</label>
                                <textarea
                                    id="officeAddress"
                                    placeholder="Enter office address"
                                    {...register('officeAddress', { required: "Address is required" })}
                                    className={`bg-gray-50 border ${errors.officeAddress ? "border-red-500" : "border-gray-300 dark:border-gray-600"} text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700  dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500`}
                                />
                                {errors.officeAddress && <p className="mt-2 text-xs text-red-600 dark:text-red-400">{errors.officeAddress.message}</p>}
                            </div>
                        </div>
...
export default ExciseHeadOfficeAdd
