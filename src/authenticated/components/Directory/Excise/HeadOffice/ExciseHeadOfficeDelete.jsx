...
const ExciseHeadOfficeDelete = ({ setdeleteModal, deleteModal, id, setAlertMsg, fetchData }) => {
    const [removedStatus, setremovedStatus] = useState(false);
    const [msg, setMsg] = useState("");
    const handleDeleteRecordById = async () => {
        try {
            const response = await axios.delete(`/api/v1/auth/directory/excise-office/id/${id}`);
...
export default ExciseHeadOfficeDelete
