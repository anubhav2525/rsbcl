...
const RSBCLHeadOfficeDelete = ({ setdeleteModal, deleteModal, id, setAlertMsg, fetchData }) => {
    const [removedStatus, setremovedStatus] = useState(false);
    const [msg, setMsg] = useState("");
    const handleDeleteRecordById = async () => {
        try {
            const response = await axios.delete(`/api/v1/auth/directory/rsbcl-office/id/${id}`);
