...
const RSBCLDepotsAdd = () => {
    ...
    const saveData = async (data) => {
        ...
        formData.append('depotName', data.depotName);
        ...
        try {
            const response = await axios.post("/api/v1/auth/directory/rsbcl-depot", formData, {
                headers: {
        ...
        <div className='px-2 py-3'>
            ...
            <div className='bg-white border-gray-200 rounded shadow px-2 py-3  dark:bg-gray-800'>
                <div className='flex justify-between items-center'>
                    <div>
                        <h5 className="text-xl px-3 font-bold dark:text-white">Add new directory RSBCL: Depots</h5>
                    </div>
                    <div>
                        ...
                        <div className='w-full grid grid-cols-1 md:grid-cols-2 gap-4'>
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    className={`bg-gray-50 border ${errors.depotName ? "border-red-500" : "border-gray-300 dark:border-gray-600"} text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700  dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500`}
                                />
                                {errors.depotName && <p className="mt-2 text-xs text-red-600 dark:text-red-400">{errors.depotName.message}</p>}
                            </div>
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    className={`bg-gray-50 border ${errors.phoneNo ? "border-red-500" : "border-gray-300 dark:border-gray-600"} text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700  dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500`}
                                />
                                {errors.phoneNo && <p className="mt-2 text-xs text-red-600 dark:text-red-400">{errors.phoneNo.message}</p>}
                            </div>
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    className={`bg-gray-50 border ${errors.address ? "border-red-500" : "border-gray-300 dark:border-gray-600"} text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700  dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500`}
                                />
                                {errors.address && <p className="mt-2 text-xs text-red-600 dark:text-red-400">{errors.address.message}</p>}
                            </div>
