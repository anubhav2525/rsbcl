...
const FocusDelete = ({ setdeleteModal, deleteModal, id, setAlertMsg, fetchData }) => {
  ...
  const handleDeleteRecordById = async () => {
    try {
      const response = await axios.delete(`/api/v1/auth/inFocus/id/${id}`);
  ...
  return (
    <div>
      <div>
        ...
        <h3 className="mb-2 text-lg font-normal text-gray-500 dark:text-gray-100">Are you sure you want to delete this focus ?</h3>
        <p className="mb-5 text-sm font-normal text-gray-500 dark:text-gray-200">Focus id: {id}</p>
