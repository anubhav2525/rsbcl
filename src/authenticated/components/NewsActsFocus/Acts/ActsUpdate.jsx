...
const ActsUpdate = () => {
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            try {
                const response = await axios.get(`/api/v1/auth/acts-policies/id/${id}`);
                ...
                console.error("Error fetching acts policies", error);
            }
        };
        fetchData();
    }, [id, reset]);
    ...
    const updateData = async (data) => {
        ...
        try {
            const response = await axios.put(`/api/v1/auth/acts-policies/id/${id}`, formData, {
                headers: {
