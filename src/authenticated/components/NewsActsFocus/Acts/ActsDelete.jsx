...
const ActsDelete = ({ setdeleteModal, deleteModal, id, setAlertMsg, fetchData }) => {
    ...
    return (
        <div>
            <div>
                ...
                <h3 className="mb-2 text-lg font-normal text-gray-500 dark:text-gray-100">Are you sure you want to delete this act, policies?</h3>
                <p className="mb-5 text-sm font-normal text-gray-500 dark:text-gray-200">Act id: {id}</p>
