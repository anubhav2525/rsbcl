...
const RevenueListBeer = ({ data }) => {
    return (
        <div className="relative overflow-x-auto">
            <h5 className="text-xl font-bold dark:text-white py-4 px-2">Revenue Beer</h5>
            <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                <thead className="text-sm text-white capitalize from-blue-500 via-blue-600 to-blue-700 bg-gradient-to-br rounded-md ease-in-out hover:shadow transition-all">
                    <tr>
                        ...
                        <th scope="col" className="px-3 py-2">Total(F)</th>
                ...
                <tbody>
                    {data.map((item, index) => (
                        <tr key={index} className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                            ...
                            <td className="px-3 py-2">{item.f}</td>
                            <td className="px-3 py-2">{item.total}</td>
                            <td className="px-3 py-2"><LastUpdate date={item.id.date} /></td>
                        </tr>
                    ))}
                </tbody>
            </table>
...
export default RevenueListBeer;
