            ...
            <div class="relative bg-white shadow-md dark:bg-gray-800 sm:rounded-t-lg">
                ...
                <div class="flex flex-col items-center justify-between p-4 space-y-3 md:flex-row md:space-y-0 md:space-x-4">
                    ...
                    <div class="flex flex-col items-stretch justify-end flex-shrink-0 w-full space-y-2 md:w-auto md:flex-row md:space-y-0 md:items-center md:space-x-3">
                        <button type="button" class="flex items-center justify-center px-4 py-2 text-sm font-medium text-white hover:shadow-inner hover:shadow-slate-100 dark:hover:shadow-blue-900 from-blue-500 via-blue-600 to-blue-700 bg-gradient-to-br  rounded-md ease-in-out transition-all">
