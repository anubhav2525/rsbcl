                ...
                <div className='p-4'>
                    <div className='w-full gap-y-4 grid md:grid-cols-2 md:gap-x-4'>
                        ...
                        <div>
                            ...
                            {errors.jobDetail?.jobTitle && (
                                <p className="text-red-600 text-sm mt-1">{errors.jobDetail.jobTitle.message}</p>
                            )}
                        </div>
                        ...
                        <div>
                            ...
                            <select
                                id="employmentType"
                                {...register("jobDetail.employmentType")}
                                className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                            ...
                            {errors.jobDetail?.employmentType && (
                                <p className="text-red-600 text-sm mt-1">{errors.jobDetail.employmentType.message}</p>
                            )}
                        </div>
                        ...
                        <div>
                            ...
                            <select
                                id="employeeStatus"
                                {...register("jobDetail.employeeStatus")}
                                className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                            ...
                            {errors.jobDetail?.employeeStatus && (
                                <p className="text-red-600 text-sm mt-1">{errors.jobDetail.employeeStatus.message}</p>
                            )}
                        </div>
                        ...
                        <div>
                            ...
                            <input
                                ...
                                {...register("jobDetail.salary")}
                                className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" />
                            {errors.jobDetail?.salary && (
                                <p className="text-red-600 text-sm mt-1">{errors.jobDetail.salary.message}</p>
                            )}
                        </div>
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    id="dateOfJoining"
                                    {...register("jobDetail.dateOfJoining")}
                                    type="date"
                                    className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                />

                            </div>
                            {errors.jobDetail?.dateOfJoining && (
                                <p className="text-red-600 text-sm mt-1">{errors.jobDetail.dateOfJoining.message}</p>
                            )}
                        </div>
                    </div>
                </div>
