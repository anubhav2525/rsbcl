            ...
            <div className='p-4'>
                <div className='w-full grid grid-cols-1 md:grid-cols-3 gap-4'>
                    <div>
                        ...
                        {errors.firstName && <p className="mt-2 text-end text-xs text-red-600 dark:text-red-400">{errors.firstName.message}</p>}
                    </div>
                    <div>
                        <label
                            htmlFor="middleName"
                        ...
                        <input
                            ...
                            {...register('middleName')}
                            className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" maxLength={40}/>
                        {errors.middleName && <p className="mt-2 text-end text-xs text-red-600 dark:text-red-400">{errors.middleName.message}</p>}
                    </div>
                    <div>
                        <label
                            htmlFor="lastName"
                        ...
                        <input
                            ...
                            {...register('lastName')}
                            className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" maxLength={40} />
                        {errors.lastName && <p className="mt-2 text-end text-xs text-red-600 dark:text-red-400">{errors.lastName.message}</p>}
                    </div>
                    <div>
                        <label
                            htmlFor="gender"
                        ...
                        {errors.gender && <p className="mt-2 text-end text-xs text-red-600 dark:text-red-400">{errors.gender.message}</p>}
                    </div>
                    <div>
                        <label
                        ...
                        {errors.maritalStatus && <p className="mt-2 text-end text-xs text-red-600 dark:text-red-400">{errors.maritalStatus.message}</p>}
                    </div>
                    <div>
                        <label
                            htmlFor="dateOfBirth"
                        ...
                        {errors.dateOfBirth && <p className="mt-2 text-end text-xs text-red-600 dark:text-red-400">{errors.dateOfBirth.message}</p>}
                    </div>
                </div>
            </div>
        </div>
